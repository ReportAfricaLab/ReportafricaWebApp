    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.gstatic.com https://*.firebaseio.com https://*.googleapis.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https: http:; font-src 'self' data:; connect-src 'self' https://api.reportafrica.africa https://*.firebaseio.com https://*.googleapis.com https://fcm.googleapis.com https://api.mapbox.com https://*.tiles.mapbox.com wss://api.reportafrica.africa https://*.s3.eu-west-1.amazonaws.com https://www.gstatic.com; frame-src 'self' https://www.google.com; media-src 'self' blob: https:; frame-ancestors 'none'" },
