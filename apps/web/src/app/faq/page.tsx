...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'When are payouts made?', a: 'Tips, bounties, assignments, breaking news bonus, sponsorship rewards: instant on approval or trigger — paid directly to your bank with no holding period. Marketplace commissions: instant when the client approves your work (funds are held in Paystack escrow, not by ReportAfrica). Fan subscriptions: instant when your subscriber\'s monthly charge goes through. Ad revenue pool: distributed weekly every Monday at 09:00 UTC (this is platform revenue being redistributed, not your funds being held). Trust bonus: distributed monthly on the 1st (same — platform revenue redistribution).' },
