  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-16">
        <span className="inline-block px-3 py-1 text-xs font-semibold text-blue-700 bg-blue-50 rounded-full mb-4">For Government & NGOs</span>
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Real-Time Civic Intelligence<br />for Decision Makers</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">Monitor citizen reports, emergencies, and elections across your jurisdiction — powered by Africa's largest citizen reporting network.</p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mb-16">
        {[
          ...
          { icon: '🗳️', title: 'Election Monitoring', desc: 'Track election reports, incidents, uploaded results, and live broadcasts.' },
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 mb-16">
        {[
          ...
          { tier: 'Agency Basic', price: '$500', period: '/month', features: ['90 day history', 'CSV export', 'Real-time alerts', 'State filter'], cta: 'Contact Sales' },
          { tier: 'Agency Pro', price: '$2,000', period: '/month', features: ['1 year history', 'PDF reports', 'Election monitoring', 'API access', 'Priority support'], cta: 'Contact Sales', popular: true },
          { tier: 'Enterprise', price: '$5,000', period: '/month', features: ['Unlimited history', 'Multi-user seats', 'Custom integration', 'Webhook alerts', 'Dedicated support', 'Full country access'], cta: 'Contact Sales' },
        ].map((plan) => (
          <div key={plan.tier} className={`rounded-xl p-6 border ${plan.popular ? 'border-[#0F7B6C] ring-2 ring-[#0F7B6C]/20' : 'border-gray-200'}`}>
            ...
            <a href="https://gov.reportafrica.africa/login" className={`block mt-4 py-2 text-center text-sm font-semibold rounded-lg ${plan.popular ? 'bg-[#0F7B6C] text-white' : 'bg-gray-100 text-gray-700'}`}>
              {plan.cta}
            </a>
          </div>
        ))}
      ...
      <div className="text-center bg-[#0F7B6C]/5 rounded-2xl p-10 border border-[#0F7B6C]/10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href="https://gov.reportafrica.africa/login" className="px-8 py-3 bg-[#0F7B6C] text-white font-semibold rounded-lg hover:bg-[#0B6E4F]">
            Start 30-Day Free Trial
          </a>
          <a href="mailto:gov@reportafrica.africa" className="px-8 py-3 bg-white border border-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-50">
            Request Demo
          </a>
        </div>
      </div>
